				...
				<div id="mycarousel" class="carousel slide" data-ride="carousel">
					<div class="carousel-inner">
						<div class="item active">
							<img src="${pageContext.request.contextPath}/image/12.jpg" alt="">
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath}/image/22.jpg" alt="">
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath}/image/23.jpg" alt="">
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath}/image/24.jpg" alt="">
						</div>
					</div>
			...
			<div class="row">
				<div class="col-sm-6 col-md-4">
					...
					<div class="thumbnail">
						...
						<img src="${pageContext.request.contextPath}/shopimage/${meirong.imagePaths[0].path}" alt="..." >
						</a>
						<div class="caption">
