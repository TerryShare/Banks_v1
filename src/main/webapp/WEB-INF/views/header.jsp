...
<div class="row">
	<div class="col-md-4" role="navigation">
		...
		<ul class="nav nav-pills">
			...
			<c:if test="${!empty sessionScope.user}">
				<li class="info-a"><a
					href="${pageContext.request.contextPath}/information"
		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand"
					...
					src="${pageContext.request.contextPath}/image/logss.jpg" width="100px" 
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li><a class="a-color"
						href="${pageContext.request.contextPath}/information">个人信息</a></li>
					<li><a class="a-color"
